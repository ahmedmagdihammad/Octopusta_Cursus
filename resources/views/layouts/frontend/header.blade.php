<header class="header clearfix">
    ...
    <div class="header_right">
        <ul>
            ...
            <li>
                <a href="#" class="option_links"><i class='uil uil-home-alt'></i><span class="noti_count">9+</span></a>
            </li>
            <li class="ui dropdown">
                ...
                <div class="menu dropdown_ms">
                    ...
                    <a href="#" class="channel_my item">
                        <div class="profile_link">
                            <img src="{{asset('frontend/images/left-imgs/img-5.jpg')}}" alt="">
                            <div class="pd_content">
                                <h6>Joy Dua</h6>
                    ...
                    <a href="#" class="channel_my item">
                        <div class="profile_link">
                            <img src="{{asset('frontend/images/left-imgs/img-8.jpg')}}" alt="">
                            <div class="pd_content">
                                <h6>Jass</h6>
            ...
            <li class="ui dropdown">
                ...
                <div class="menu dropdown_mn">
                    ...
                    <a href="#" class="channel_my item">
                        <div class="profile_link">
                            <img src="{{asset('frontend/images/left-imgs/img-2.jpg')}}" alt="">
                            <div class="pd_content">
                                <h6>Jassica Smith</h6>
            ...
            <li class="ui dropdown">
                ...
                <div class="menu dropdown_account">
                    ...
                    <a class="item channel_item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">Sign Out</a>
