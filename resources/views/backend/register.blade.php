...
<div class="register-box">
    ...
    <form action="{{ route('register.create') }}" method="post">
        ...
        <div class="form-group has-feedback">
            <input type="text" name="mobile" class="form-control{{ $errors->has('mobile') ? ' is-invalid' : '' }}" value="{{ old('mobile') }}" placeholder="Mobile" required autofocus>
        ...
        <div class="form-group has-feedback">
            <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="Email" required autofocus>
        ...
        <div class="form-group has-feedback hide">
            <input type="text" name="type" class="form-control" value="A" placeholder="Type" required>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="row">
        <div class="col-xs-8">
