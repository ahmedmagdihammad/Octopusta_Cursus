                            ...
                            <div class="owl-carousel featured_courses owl-theme">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <a href="{{route('course_detail_view', $s->id)}}" class="fcrse_img">
                                            <img src="{{asset('frontend/images/courses/img-2.jpg')}}" alt="">
                                        ...
                                        <div class="fcrse_content">
                                            ...
                                            <a href="{{route('course_detail_view', $s->id)}}" class="crse14s">{{$s->name}}</a>
                        ...
                        <div class="la5lo1">
                            <div class="owl-carousel featured_courses owl-theme">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <a href="{{route('course_detail_view', $s->id)}}" class="fcrse_img">
                                            <img src="{{asset('frontend/images/courses/img-18.jpg')}}" alt="">
                                            <div class="course-overlay">
                                                <span class="play_btn1"><i class="uil uil-play"></i></span>
                                                <div class="crse_timer">
                                                    15 hours
                        ...
                        <div class="la5lo1">
                            <div class="owl-carousel top_instrutors owl-theme">
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-1.jpg')}}" alt=""></a>												
                                        </div>
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-2.jpg')}}" alt=""></a>											
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-3.jpg')}}" alt=""></a>												
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-4.jpg')}}" alt=""></a>											
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-5.jpg')}}" alt=""></a>												
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-7.jpg')}}" alt=""></a>												
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-8.jpg')}}" alt=""></a>												
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                                ...
                                <div class="item">
                                    <div class="fcrse_1 mb-20">
                                        <div class="tutor_img">
                                            <a href="instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-6.jpg')}}" alt=""></a>												
                                        </div>
                                        <div class="tutor_content_dt">
                                            <div class="tutor150">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="right_side">
                        <div class="fcrse_2 mb-30">
                            <div class="tutor_img">
                                <a href="my_instructor_profile_view.html"><img src="{{asset('frontend/images/left-imgs/img-10.jpg')}}" alt=""></a>												
                            </div>
                            <div class="tutor_content_dt">
                                <div class="tutor150">
                            ...
                            <div class="owl-carousel Student_says owl-theme">
                                ...
                                <div class="item">
                                    <div class="fcrse_4 mb-20">
                                        ...
                                        <div class="st_group">
                                            <div class="stud_img">
                                                <img src="{{asset('frontend/images/left-imgs/img-1.jpg')}}" alt="">												
                                            </div>
                                            <h4>Rock Smith</h4>
                                        </div>											
                                    </div>
                                ...
                                <div class="item">
                                    <div class="fcrse_4 mb-20">
                                        ...
                                        <div class="st_group">
                                            <div class="stud_img">
                                                <img src="{{asset('frontend/images/left-imgs/img-7.jpg')}}" alt="">												
                                            </div>
                                ...
                                <div class="item">
                                    <div class="fcrse_4 mb-20">
                                        ...
                                        <div class="st_group">
                                            <div class="stud_img">
                                                <img src="{{asset('frontend/images/left-imgs/img-6.jpg')}}" alt="">												
                                            </div>
                                            <h4>Poonam Sharma</h4>
                                        </div>											
                                    </div>
                                ...
                                <div class="item">
                                    <div class="fcrse_4 mb-20">
                                        ...
                                        <div class="st_group">
                                            <div class="stud_img">
                                                <img src="{{asset('frontend/images/left-imgs/img-3.jpg')}}" alt="">												
                                            </div>
